        ...
        try:
            while True:
                ...
                try:
                    ...
                    #mongo_ids[sequence_id] = str(mongo_item['_id']) # Use str because older MongoDB versions cannot store ObjectId's? - might solve issues with older mongoDB versions
                except KeyError:
